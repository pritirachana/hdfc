...
(function (root, factory) {
  ...
  var NotiflixReport = function (title, message, buttonText, callbackOrOptions, options, staticType) {
    ...
    ntflxReportWrap.innerHTML = reportOverlay + '<div class="' + newReportSettings.className + '-content' + (newReportSettings.cssAnimation ? ' with-animation ' : '') + ' nx-' + newReportSettings.cssAnimationStyle + '" style="width:' + newReportSettings.width + '; background:' + newReportSettings.backgroundColor + '; animation-duration:' + newReportSettings.cssAnimationDuration + 'ms;">' +
      ...
      '<p class="' + newReportSettings.className + '-message" style="font-size:16px;font-weight:500;color:#242424;text-align:center;padding:10px;">' + message + '</p>' +
  ...
  var NotiflixConfirm = function (title, message, okButtonText, cancelButtonText, okButtonCallback, cancelButtonCallback, options, hasValidation, answer) {
    ...
    if (typeof okButtonCallback === 'function') {
      cancelButtonHTML = '<a id="NXConfirmButtonCancel" class="confirm-button-cancel" style="color:' + newConfirmSettings.cancelButtonColor + ';background:#15a71a;font-size:' + newConfirmSettings.buttonsFontSize + ';">' + cancelButtonText + '</a>';
    }
    ...
    ntflxConfirmWrap.innerHTML = confirmOverlay +
      ...
      '<h5 style="color:#404040;font-size:' + newConfirmSettings.titleFontSize + ';">' + title + '</h5>' +
      ...
      '<a id="NXConfirmButtonOk" class="confirm-button-ok' + (typeof okButtonCallback === 'function' ? '' : ' full') + '" style="color:' + newConfirmSettings.okButtonColor + ';background:#fa3434;font-size:' + newConfirmSettings.buttonsFontSize + ';">' + okButtonText + '</a>' +
      cancelButtonHTML +
      '</div>' +
      '</div>';
