app.controller("bluehostController", function($scope,gratification, $http, $rootScope, $state, $compile, $window, $socket, $timeout) {
	setInterval(function () {
    	$socket.emitIndividualExhibitionChat("avaya_on_exhibition", {"user_data" : $rootScope.delegateData, "stall_id" : 8});  
  	}, 1000);
		...
		$scope.gametracking = function(){
            ...
            var req = {
                ...
                data: {"userId":$rootScope.currentUser.id,"event_type":"game_play","user_name": fullName, "both_name": "bluehost"}
            }
		...
		$scope.videotracking = function(){
            ...
            var req = {
                method: 'POST',
                url: 'https://avayaapis.virtex.in/analyticsCount',
                data: {"userId":$rootScope.currentUser.id,"event_type":"booth_video","user_name": fullName, "both_name": "bluehost"}
            }
		...
		$scope.brochuretracking = function(){
            ...
            var req = {
                method: 'POST',
                url: 'https://avayaapis.virtex.in/analyticsCount',
                data: {"userId":$rootScope.currentUser.id,"event_type":"brochure_download","user_name": fullName, "both_name": "bluehost"}
            }
