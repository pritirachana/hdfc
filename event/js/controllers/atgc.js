app.controller("atgcController", function($scope,$http, $rootScope, $state, $compile, $window, $socket, $timeout,gratification,$sce,$timeout) {
...
// var chat = angular.element(document.querySelector('#chat-app'));
   ...
   $http.post('https://devapi.virtex.in/api/cii-bio/get-session',{stageType:2}).then(function(result){
    console.log(result);
