app.controller("mediaController", function($scope,gratification, $http, $rootScope, $state, $compile, $window, $socket, $timeout,gratification,$sce) {
    ...
    $scope.myTrigger = function(arg) {
        ...
        if (arg == 'video') {
            ...
            $scope.popupvideo13 = true;
        }if (arg == 'video14') {
            $scope.popupvideo14 = true;
    ...
    $scope.closePopup = function() {
        ...
        $scope.popupvideo13 = false;
        $scope.popupvideo14 = false;
    }
