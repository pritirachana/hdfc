app.controller("assertionController", function($scope, $rootScope, $state, $compile, $window, $socket, $timeout,gratification,$sce) {


    $scope.broucherDownload = function(url){
        gratification.sendPoints('user_self_activity','assertion_booth_broucher','Assertion');
        $window.open(url, '_blank');
    }

    gratification.sendPoints('user_self_activity','assertion_booth_enter','Assertion');
