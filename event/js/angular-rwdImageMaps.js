            ...
            link: function(scope, element, attrs) {
                element.bind('load', function() {
                    ...
                    function resize() {
                        ...
                        //    var newval = angular.copy(element);
                        //console.log(newval);
                    ...
                    //         console.log('called');
                    //         angular.element($window).bind('resize', resize).trigger('resize');
                    //     }
                    // });
                    // angular.element(document.querySelectorAll('#content')[0]).bind('resize', resize).trigger('resize');
                    angular.element($window).bind('resize', resize).trigger('resize');
